...
batch_algs_case = [3];                  % batch IVA的类型,1-auxiva,2-MNMF，3-EMIVA，4-IVE ，控制本函数内算法,5-EMIVA_fast
online_algs_case = [3];                 % online IVA的类型,1-auxiva,2-MNMF，3-EMIVA，4-IVE
...
%     sav=['save ' strsave]; eval(sav);
    ...
    if real_result == 1 %% 按照sep1_method1方式命名 'case_',case_str, 'case_',case_str,
