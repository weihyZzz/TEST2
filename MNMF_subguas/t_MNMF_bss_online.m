function [sep,label] = t_MNMF_bss_online(mix,ns,option)
...
if ILRMA_init == 1
    ...
    % Online tMNMF
     Y = t_MNMF_online(x,XX,ns,MNMF_nb,MNMF_it,MNMF_drawConv,v,trial,MNMF_batch_size,MNMF_first_batch,MNMF_rho,G);
else
%     Y = online_multichannelNMF(x,XX,ns,MNMF_nb,MNMF_it,MNMF_batch_size,MNMF_first_batch,MNMF_rho);
     Y = t_MNMF_online(x,XX,ns,MNMF_nb,MNMF_it,MNMF_drawConv,v,trial,MNMF_batch_size,MNMF_first_batch,MNMF_rho);
end
% % Y = zeros(I,J,M,2);
% % for i = 1:I
% %     for j = 1:J
