function [sep,label] = t_FastMNMF_bss_online(mix,ns,option)
% ns: source_num
% M : mic_num
% I : frequence bin
% J : time-frame bin
...
%% online FastMNMF
    [Y] = t_FastMNMF_online(X,XX,ns,MNMF_nb,MNMF_it,MNMF_drawConv,v,trial,MNMF_batch_size,MNMF_first_batch,MNMF_rho,scalelap);
% %%% qxº∆À„
% QX = zeros(I,J,M);
% for ii = 1:I
