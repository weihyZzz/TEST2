...
[Tnume_NFK ,Tdeno_NFK] = local_Tfrac( QY_FTM, Yhat_FTM, V_NKT, G_NM, F, T, K, M ,N); % F x K         % % (20) of [2]分子更新
...
[Vnume_NKT ,Vdeno_NKT] = local_Vfrac( QY_FTM, Yhat_FTM, T_NFK, G_NM, F, T, K, M ,N); % F x K         % % (21) of [2]分子更新
...
%%%%% Update G %%%%%
QY_FTM = (QX_power./(Yhat_FTM).^2);
[Gnume_FNM ,Gdeno_FNM] = local_Gfrac( QY_FTM, Yhat_FTM, T_NFK, V_NKT, F, T, M ,N); % F x K         % % (22) of [2]分子更新
G_NM = sqrt(Fjaxa(G_NM, Gnume_FNM, Ghat_FNM, Gnumehat_FNM, rho) ./ Fjx(Gdeno_FNM, Gdenohat_FNM, rho))+ 1e-10; % 类比(43) of [3]
