function [sep,label] = mpdf_FastMNMF_bss_online(mix,ns,option)
% ns: source_num
% M : mic_num
% I : frequence bin
% J : time-frame bin
...
%% online FastMNMF-mpdf
    [Y] = mpdf_FastMNMF_online(X,XX,ns,MNMF_nb,MNMF_it,MNMF_drawConv,v,trial,MNMF_batch_size,MNMF_first_batch,MNMF_rho,scalelap,pro);
% %% offline FastMNMF
%     [Xhat,T,V,G,Q,~] = mpdf_FastMNMF_online(X,XX,ns,MNMF_nb,MNMF_it,MNMF_drawConv,v,trial);
% %%% qxº∆À„
% QX = zeros(ns,I,J,M);
% for n=1:ns
% for ii = 1:I
