...
[Tnume ,Tdeno] = local_Tfrac( phiY_FTM, Yhat_FTM, V_NKT, G_FNM, F, T, K, M ,N, indice); % F x K         % % (19) of [2]更新
...
%% %%% Update G %%%%%
  %%标准迭代
phiY_FTM = (phi./(Yhat_FTM+eps).^2);% phi * y.^-2 in (19) of [2]
[Gnume ,Gdeno] = local_Gfrac( phiY_FTM, Yhat_FTM, T_NFK, V_NKT, F, T, M ,N, indice); % F x K         % % (22) of [2]更新
