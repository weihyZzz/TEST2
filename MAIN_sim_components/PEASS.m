...
estimateFile = 'mix';%filenameTmp(:,1:end-4);

%%%%%%%%%%%%%
% Set options
%%%%%%%%%%%%%
option.fs_ref=fs_ref;
option.destDir = 'peassaudio_save/';
option.segmentationFactor = 0; % increase this integer if you experienced "out of memory" problems

%%%%%%%%%%%%%%%%%%%%
% Call main function
%%%%%%%%%%%%%%%%%%%%
res = PEASS_ObjectiveMeasure(estimateFile,option);
